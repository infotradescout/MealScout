...
const baseline: Record<string, number> = {
  ...
  "server/routes/eventCoordinatorRoutes.ts": 1,
  ...
  "server/routes/stripeWebhookRoutes.ts": 4,
  ...
  "server/services/pickupOrderNotificationService.ts": 1,
  "server/truckEventMatchService.ts": 2,
  "server/unifiedAuth.ts": 4,
