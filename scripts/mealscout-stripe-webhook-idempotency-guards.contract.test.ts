...
// available in this environment, and MEALSCOUT_PAYMENT_WEBHOOK_SAFETY_MAP.md
// (C9-F5) already flags that stateful payment smokes stay behind explicit
// fixture/env approval. scripts/testParkingPassWebhookReplay.ts and
// scripts/auditParkingPassWebhookReconciliation.ts remain the tools for that
// once a safe fixture environment exists.
//
