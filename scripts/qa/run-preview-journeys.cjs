...
execute('scout-profile-state', ['--import', 'tsx', '--test', 'scripts/qa/public-profile-recovery.test.ts', 'scripts/qa/scout-journey-state.test.ts', 'scripts/qa/carto-basemap.test.ts', 'scripts/qa/scout-feed-read.test.ts', 'scripts/qa/public-menu-recovery.test.ts']);
