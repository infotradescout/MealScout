...
if (process.env.MEAL_SIGNUP_HANDOFF_MODE === "observe") {
  await import("./observeSignupHandoffResilience.mjs");
} else if (process.env.MEAL_SIGNUP_HANDOFF_MODE === "validate") {
...
} else if (process.env.MEAL_HOST_INDEXNOW_MODE) {
