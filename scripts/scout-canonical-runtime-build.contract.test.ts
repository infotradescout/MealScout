...
if (
  appSource.includes('import("@/pages/explore-preview")') ||
  appSource.includes('import("@/pages/scout-prototype")')
) {
  throw new Error("App.tsx must not retain obsolete Scout implementations.");
}
