  ...
  const siteStructure = [
    ...
    },
    {
      ...
      pages: [
        ...
        { title: "For Bars", href: "/for-bars", description: "Bar specials, menus, events, and local discovery" },
        ...
        { title: "Public Events", href: "/events", description: "Upcoming public food events and activity" },
      ],
    },
    {
