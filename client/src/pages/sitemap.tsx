  ...
  const siteStructure = [
    {
      ...
      pages: [
        ...
        { title: "Discovery Beyond Delivery Apps", href: "/delivery-app-alternatives", description: "Local discovery with no delivery-network parity claim" },
        { title: "Eligible Pickup Ordering", href: "/online-ordering-platforms", description: "Local profiles plus limited eligibility-gated ASAP pickup" },
