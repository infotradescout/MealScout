...
/* ============================================================
   FLOATING ATMOSPHERIC BOTTOM NAV (4 items, no Scout)
   ============================================================ */
...
function AtmosphericBottomNav({ hidden }: { hidden?: boolean }) {
  ...
  return (
    ...
    >
      <div
        className="mx-auto max-w-md flex items-center justify-between gap-1 h-[64px] px-4 rounded-full bg-black/65 backdrop-blur-xl ring-1 ring-white/10"
        style={{
          boxShadow:
