...
export const businessWorkspaceModules = [
  ...
  { title: "Audience", text: "Understand and reach the people already interacting with the business." },
...
export const aboutFeatureGroups: AboutFeatureGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "Profile, menu, specials, and directions QR assets with measurable opens",
