...
- Public affiliate attribution uses direct clean links `/<safe-internal-path>/<affiliateTag>` for generated shares; legacy `/ref/...` remains redirect-only compatibility.
