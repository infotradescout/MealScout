    ...
    try {
      ...
      const [row] = await db
        .select({
          ...
          hostGooglePhotos: hosts.googlePhotos,
          hostFacebookCoverUrl: hosts.facebookCoverUrl,
          truckName: restaurants.name,
      ...
      res.json({
        ...
        host: {
          ...
          spotImageUrl: row.hostSpotImageUrl,
          googlePhotos: row.hostGooglePhotos,
          facebookCoverUrl: row.hostFacebookCoverUrl,
          path: hostPath,
        },
