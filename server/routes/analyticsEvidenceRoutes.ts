...
import { registerPublicProfileQualityRoute } from "./publicProfileQualityRoute";
...
export function registerAnalyticsRoutes(app: Express) {
  registerPublicProfileQualityRoute(app, async (record) => {
    await db.insert(requestLogs).values(record);
  });
